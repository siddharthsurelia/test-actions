...
#c.JupyterHub.ssl_key = '/etc/jupyterhub/certs/cert.key'
#c.JupyterHub.ssl_cert = '/etc/jupyterhub/certs/cert.cer'
...
#        <option value="mltools.docker.repositories.sap.ondemand.com/ml-training-gpu">jupyter-gpu</option>
#        <option value="mltools.docker.repositories.sap.ondemand.com/ml-jupyterhub-chargrid">chargrid</option>
#        </select>
...
from DemoFormSpawner import DemoFormSpawner, create_dir_hook
...
#c.DockerSpawner.volumes = { '/data/export/{username}': '/home/jovyan/nfs', '/raid/ssh-shared': '/home/jovyan/ssd-shared', '/data/export/nfs-shared': '/home/jovyan/nfs-shared', '/raid/{username}': '/home/jovyan/ssd'}
c.DockerSpawner.volumes = {  '/raid/ssh-shared': '/home/jovyan/ssd-shared', '/data/export/nfs-shared': '/home/jovyan/nfs-shared'}
c.DockerSpawner.remove_containers = False
# c.DockerSpawner.extra_host_config = {'runtime': 'nvidia'}
c.Spawner.default_url = '/lab'

####################################################################
# Separathe the proxy from the hub
####################################################################
...
from oauthenticator.sapgithub import LocalGitHubOAuthenticator
c.JupyterHub.authenticator_class = LocalGitHubOAuthenticator

# GitHub OAuth Login
c.LocalGitHubOAuthenticator.oauth_callback_url = 'https://jupyterhub-qa-bm.ml.only.sap/hub/oauth_callback'
c.LocalGitHubOAuthenticator.client_id = '<client-id>'
c.LocalGitHubOAuthenticator.client_secret = '<client-secret>'
...
c.Authenticator.admin_users = {'mlops','I342929', 'I332084','I518711'}

####### user whitelist #############################
#c.Authenticator.whitelist = {"mlops","D071503","D065887","D062884","I342929","I332084","I859059","D071607","I518711","D071406","D071932","D071780","D068012","D071211","D071576","D069450","D071704","D070941","D070416","D069450","I346047","D057453","I048261","D054126","D063216","I539796","I539868","I539756","I539870","I048261","D065372","D047359","D071286","I344478","D072955","I858709","I535110","I542512","D065303","D054176"}
